...
class SVGADynamicEntity {
  ...
  Future<void> setImageWithUrl(String url, String forKey, {Map<String, String>? imageHeader}) async {
    this.dynamicImages[forKey] =
        await decodeImageFromList((await get(Uri.parse(url), headers: imageHeader)).bodyBytes);
  }
