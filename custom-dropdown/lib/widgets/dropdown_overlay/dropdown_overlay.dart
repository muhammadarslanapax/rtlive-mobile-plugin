...
class _DropdownOverlayState<T> extends State<_DropdownOverlay<T>> {
  ...
  Widget headerBuilder(BuildContext context) {
    return widget.headerBuilder != null ? widget.headerBuilder!(context, selectedItem as T) : defaultHeaderBuilder(context, item: selectedItem);
  }

  Widget headerListBuilder(BuildContext context) {
    return widget.headerListBuilder != null ? widget.headerListBuilder!(context, selectedItems) : defaultHeaderBuilder(context, items: selectedItems);
  }
              ...
              child: DecoratedBox(
                ...
                child: Material(
                  ...
                  child: _AnimatedSection(
                    ...
                    child: SizedBox(
                      key: key2,
                      height: items.length > 4 ? widget.overlayHeight ?? (onSearch ? 325 : 225) : null,
                      child: ClipRRect(
                        borderRadius: decoration?.expandedBorderRadius ?? _defaultBorderRadius,
                                        ...
                                        children: [
                                          Expanded(
                                            child: switch (widget.dropdownType) {
                                              ...
                                              _DropdownType.multipleSelect => selectedItems.isNotEmpty ? headerListBuilder(context) : hintBuilder(context),
                                            },
                                          ),
